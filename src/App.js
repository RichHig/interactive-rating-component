  ...
  return (
    <div className="wrapper">
     ...
     <div className="flex items-center justify-center">
      ...
      <p className="text-gray-400 text-center mb-10">We appreciate you taking the time to give a rating. If you ever need more support, dont't hesistate to get in touch!</p>
      <div className="text-center">
